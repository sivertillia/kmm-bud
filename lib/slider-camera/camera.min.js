(function (a) {
    a.fn.camera = function (H, V) {
        ...
        if (H.navigation == true) {
            D.append('<div class="camera_prev"><i class="fa fa-angle-left" aria-hidden="true"></i></div>').append('<div class="camera_next"><i class="fa fa-angle-right" aria-hidden="true"></i></div>')
        }
        ...
        function v() {
            ...
            function u() {
                ...
                a(".imgLoaded", b).each(function () {
                    var az = a(this), ay = az.attr("width"), ar = az.attr("height"), au = az.index(), at, aq,
                        aw = az.attr("data-alignment"), ax = az.attr("data-portrait");
        ...
        if (ag.length != 0) {
            ...
            if (ab == true) {
                a(am, ae).animate({opacity: 1}, 0);
                a(r, ae).animate({opacity: 1}, 0);
                a(R, ae).animate({opacity: 1}, 0);
                if (L()) {
                    ...
                    a(document).on("vmouseout", W, function () {
                        a(am, ae).delay(500).animate({opacity: 1}, 200);
                        a(r, ae).delay(500).animate({opacity: 1}, 200);
                        a(R, ae).delay(500).animate({opacity: 1}, 200)
                    })
                } else {
                    D.hover(function () {
        ...
        if (a(n).length) {
            ...
            a(".camera_pag_ul li", ae).hover(function () {
                ...
                if (a(".camera_thumb", this).length) {
                    var u = a(".camera_thumb", this).outerWidth(), w = a(".camera_thumb", this).outerHeight(),
                        h = a(this).outerWidth();
                ...
                a(".camera_thumb", this).animate({"margin-top": "-20px", opacity: 1}, 200, function () {
                    a(this).css({marginTop: "5px"}).hide()
                });
                a(".thumb_arrow", this).animate({"margin-top": "-20px", opacity: 1}, 200, function () {
                    a(this).css({marginTop: "5px"}).hide()
                })
            })
        }
            ...
            if (!a(n).length) {
                ...
                a.each(j, function (h, w) {
                    if (a("> div", ag).eq(h).attr("data-thumb") != "") {
                        var ap = a("> div", ag).eq(h).attr("data-thumb"), u = new Image();
                        u.src = ap;
                        a("li.pag_nav_" + h, n).append(a(u).attr("class", "camera_thumb").css({position: "absolute"}).animate({opacity: 1}, 0));
                        a("li.pag_nav_" + h + " > img", n).after('<div class="thumb_arrow" />');
                        a("li.pag_nav_" + h + " > .thumb_arrow", n).animate({opacity: 1}, 0)
                    }
                });
        ...
        function I() {
            if (a(M).length && !a(n).length) {
                var w = a(M).outerWidth(), ap = a("ul > li", M).outerWidth(),
                    ...
                    u = (a("ul > li", M).length * a("ul > li", M).outerWidth()), ar = a("ul", M).offset().left,
                    at = a("> div", M).offset().left, h;
                if (ar < 0) {
                    h = "-" + (at - ar)
                } else {
                    h = at - ar
                            ...
                            if (bb != 0) {
                                a(".cameraSlide.cameracurrent .fadeIn", D).each(function () {
                                    ...
                                    if (bi.indexOf("fadeIn") != -1) {
                                        bn.animate({opacity: 1}, 0).css("visibility", "visible").delay((aX / bb) * (0.1 * (bd - 1))).animate({opacity: 1}, (aX / bb) * 0.15, bh)
                                    } else {
                                                        ...
                                                        if (bj.indexOf("fadeFromRight") != -1) {
                                                            ...
                                                            if (bj.indexOf("fadeFromTop") != -1) {
                                                                ...
                                                                if (bj.indexOf("fadeFromBottom") != -1) {
                                                                    bf.animate({opacity: 1}, 0).css({bottom: "-" + bd + "px"});
                                                                    bf.css("visibility", "visible").delay((aX / a8) * (0.1 * (bg - 1))).animate({
                                                                        bottom: "0",
                                                                        opacity: 1
                                                                    }, (aX / a8) * 0.15, be)
                                                                    ...
                                                                    if (bj.indexOf("fadeIn") != -1) {
                                                                        bf.animate({opacity: 1}, 0).css("visibility", "visible").delay((aX / a8) * (0.1 * (bg - 1))).animate({opacity: 1}, (aX / a8) * 0.15, be)
                                                                    } else {
                                    ...
                                    if (g <= 1.002 && !ag.hasClass("stopped") && !ag.hasClass("paused") && !ag.hasClass("hovered")) {
                                        ...
                                        if (g <= 1 && (ag.hasClass("stopped") || ag.hasClass("paused") || ag.hasClass("stopped") || ag.hasClass("hovered"))) {
                                            ...
                                            if (!ag.hasClass("stopped") && !ag.hasClass("paused") && !ag.hasClass("hovered")) {
                                                clearInterval(aa);
                                                af();
                                                a("#" + q).animate({opacity: 1}, 200, function () {
                                                    clearTimeout(ac);
                                                    ac = setTimeout(K, a7);
                                                    T();
                                                    H.onStartLoading.call(this)
                                    ...
                                    if (g <= 1.002 && !ag.hasClass("stopped") && !ag.hasClass("paused") && !ag.hasClass("hovered")) {
                                        ...
                                        if (g <= 1 && (ag.hasClass("stopped") || ag.hasClass("paused") || ag.hasClass("hovered"))) {
                                            ...
                                            if (!ag.hasClass("stopped") && !ag.hasClass("paused") && !ag.hasClass("hovered")) {
                                                clearInterval(aa);
                                                af();
                                                a("#" + q + ", .camera_canvas_wrap", U).animate({opacity: 1}, 200, function () {
                                                    clearTimeout(ac);
                                                    ac = setTimeout(K, a7);
                                                    T();
                                                    H.onStartLoading.call(this)
        ...
        if (a(am).length) {
            a(am).click(function () {
                if (!ag.hasClass("camerasliding")) {
                    ...
                    clearInterval(aa);
                    af();
                    a("#" + q + ", .camera_canvas_wrap", ae).animate({opacity: 1}, 0);
                    K();
                    if (h != 0) {
                        T(h)
                    } else {
        ...
        if (a(r).length) {
            a(r).click(function () {
                if (!ag.hasClass("camerasliding")) {
                    ...
                    clearInterval(aa);
                    af();
                    a("#" + q + ", .camera_canvas_wrap", U).animate({opacity: 1}, 0);
                    K();
                    if (h == y - 1) {
                        T(1)
                    } else {
        ...
        if (a(M).length) {
            ...
            a(".camera_thumbs_cont .camera_prevThumbs", U).hover(function () {
                ...
                a(this).stop(true, false).animate({opacity: 1.7}, 250)
            });
            a(".camera_prevThumbs", U).click(function () {
                var ap = 0, w = a(M).outerWidth(), h = a("ul", M).offset().left, u = a("> div", M).offset().left,
                    aq = u - h;
            ...
            a(".camera_nextThumbs", U).click(function () {
                var aq = 0, ap = a(M).outerWidth(), h = a("ul", M).outerWidth(), u = a("ul", M).offset().left,
                    w = a("> div", M).offset().left, ar = w - u;
                a(".camera_visThumb", M).each(function () {
